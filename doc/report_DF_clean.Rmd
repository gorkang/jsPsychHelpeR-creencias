...
# params = data.frame(last_task = "Goodbye")
...
plot_form_progress = show_progress_pid(pid = 8, files_vector = DF_clean$filename, last_task = "Goodbye", goal = 500)$PLOT_progress
...
DT::datatable(summary_position, filter = 'top', options = list(dom = 'ltip', pageLength = 12))
