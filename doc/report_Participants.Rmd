...
- En cuanto a tus niveles de depresión han sido **`r DF$depresion`**, has mostrado ansiedad **`r DF$ansiedad`** y un estrés **`r DF$estres`** (percentiles: `r DF$depresion_pct`, `r DF$ansiedad_pct` y `r DF$estres_pct`).  

- Tu estrés percibido es **`r DF$PSS`** (percentil: `r DF$PSS_pct`).  
